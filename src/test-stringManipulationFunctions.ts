...
let newLine: string = JsTypeCommander.getDefaultLineSeparatorSequence();
...
let testData: {
...
}[] = [
    {
        ...
        callback: JsTypeCommander.trimStart,
        tests: [
        ...
        fName: 'trimEnd',
        signature: '(text: string): string',
        callback: JsTypeCommander.trimEnd,
        tests: [
            { args: [""], expected: "" }, { args: [" "], expected: "" }, { args: ["\r"], expected: "" }, { args: ["\n"], expected: "" }, { args: [" \r\n "], expected: "" },
            { args: [" \r\n \r\n "], expected: "" },
            { args: ["Test \n\r\t Text"], expected: "Test \n\r\t Text" }, { args: [" Test \n\r\t Text "], expected: " Test \n\r\t Text" },
        ...
        signature: '(text: string): string',
        callback: JsTypeCommander.asNormalizedWs,
        tests: [
            { args: [""], expected: "" }, { args: [" "], expected: "" }, { args: ["\r"], expected: "" }, { args: ["\n"], expected: "" }, { args: [" \r\n "], expected: "" },
            { args: [" \r\n \r\n "], expected: "" },
        ...
        fName: 'ucFirst',
        signature: '(text: string): string',
        callback: JsTypeCommander.ucFirst,
        tests: [
        ...
        fName: 'splitLines',
        signature: '(text: string): string[]',
        callback: JsTypeCommander.splitLines,
        tests: [
            { args: [""], expected: [""] }, { args: [" "], expected: [" "] }, { args: ["\r"], expected: ["", ""] }, { args: ["\n"], expected: ["", ""] },
        ...
        callback: JsTypeCommander.indentText,
        tests: [
        ...
        fName: 'indentLines',
        signature: '(text: string|string[], indent?: string): string[]',
        callback: JsTypeCommander.indentLines,
        tests: [
            { args: [""], expected: [""] }, { args: [" "], expected: [""] }, { args: ["\r"], expected: ["", ""] }, { args: ["\n"], expected: ["", ""] },
            { args: [" \r\n "], expected: ["", ""] },
            { args: [" \r\n \r\n "], expected: ["", "", ""] }, { args: [" \r\n \n\r "], expected: ["", "", "", ""] },
